...
import dummyData from "@/app/screen/allBooking.json";
  ...
  return (
    <div className="w-full mt-4 bg-white py-4 px-3 rounded-2xl ">
      <div className="flex justify-between items-center mb-7 ">
        <div className="ml-4">
          <h2 className="text- font-bold text-black relative">All Booking</h2>
        ...
        <div className="flex items-center gap-8">
          <div className="flex">
            <input
              ...
              className=" outline-none px-3 py-1 border w-80 bg-gray-200 rounded-md border-gray-500 text-sm"
              value={searchText}
              onChange={(e) => setSearchText(e.target.value)}
            />
            <button className="m-0 -ml-5 px-7 py-2 bg-[#168D9D] text-white rounded-lg text-sm font-semibold">
              Search
            </button>
          </div>
          <Image
      ...
      <table className="w-full">
        <thead>
          <tr className=" border-b-2 border-sky-400 text-black">
            ...
            <th className="p-2 text-left font-light">Booking ID</th>
            <th className="p-2 text-left font-light">Date & Time</th>
            <th className="p-2 text-left font-light">Service</th>
        ...
        <tbody>
          ...
          {currentItems.map((item: any, index) => (
            ...
            >
              ...
              <td className="p-2 text-gray-400 text-sm">{item.booking_id}</td>
              <td className="p-2 text-gray-400 text-sm">
                {item["date & time"]}
              </td>
              <td className="p-2 text-gray-400 text-sm">{item.service}</td>
              <td
